<nav class="top-sticky navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
  <h2>Kasir</h2>
  <!-- Topbar Navbar -->
  <ul class="navbar-nav ml-auto">
      ...
      <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
        ...
        <a class="dropdown-item d-flex align-items-center" href="#">
          <div class="dropdown-list-image mr-3">
            <img class="rounded-circle" src="{{asset('/images/')}}" alt="">
    ...
    <li class="nav-item dropdown no-arrow">
      <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <img class="img-profile rounded-circle" src="{{asset('/images/' .Auth::user()->foto)}}">
      </a>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="text-center modal-body">
          <div class="container">
            <img width="150px" height="150px" class="mx-auto img-thumbnail" src="{{asset('/images/' .Auth::user()->foto)}}" alt="">
          </div>
          <div class="container">
            {{ Auth::user()->name }}
          </div>
